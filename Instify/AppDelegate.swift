    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(
            with: ParseClientConfiguration(block: { (configuration:ParseMutableClientConfiguration) -> Void in
                configuration.applicationId = "Instify"
                configuration.clientKey = "JNjnasodkjwqi2j2!3knkjpf2#f2354km4332#@!"  // set to nil assuming you have not set clientKey
                configuration.server = "https://stark-hamlet-35800.herokuapp.com/parse"
            })
        )
